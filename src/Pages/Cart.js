// this cart component is used to display users cat details, allows them to manage the cart and provides a button to purchase the products.
// react hooks
...
import firstStyles from "../styles/itemCard.module.css";
// styles for cart.js
            ...
            <div className={secondStyles.mainContainer}>
                ...
                <div className={secondStyles.header}>
                    ...
                    <div className={secondStyles.userInfo}>
                        <h1>Hi {userLoggedIn.name}, <small>My Cart has</small></h1>
                    </div>
